...
main_application.title('Kpad Text Editor')
main_application.wm_iconbitmap('icon.ico')

# Dividing the application in 5 different parts
##########   MAIN MENU ###################

# I HAVE TO ADD "FILE", "EDIT", "VIEW" AND "COLOR THEME" IN MENU BAR
...
#in color ictionary 1st color is text color and second color is background color
color_dict = {
...
main_menu.add_cascade(label='Change theme', menu=color_theme)
...
def changed(event=None):
    ...
    if text_editor.edit_modified():
        ...
        status_bar.config(text=f'Characters : {characters} Words: {words}  (MADE IN INDIA by Kapil Sharma)')
...
def find_func(event = None):
    ...
    # Sabse pahle frame create kiya
    find_frame = ttk.LabelFrame(find_dialogue, text = 'Find/Replace')
    find_frame.pack(pady = 20)

    # Frame ke andar label create kiya
